  ...
  return (
    <Layout>
      <Hero
        ...
        subcontent="Для получения более детальной информации о проекте посмотрите видео функциональных возможностей или заполните форму обратной связи. Покажем живую систему и все объясним"
